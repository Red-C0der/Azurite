...
class Azurite_Script:
    def run(self, file):
        import logger
        logger.write("i", "File: main.py | Class: Azurite_Script | Function: run | Executing protocol "+file+" !")
    ...
    #    except:
    #        logger.write("e", "File: main.py | Class: Azurite_Script | Function: open_file | Could not open file "+filename+" !")
    #        return False
    #    return data#

    #def lex(self, filecontent):
    ...
    #    logger.write("i", loggerloc+"Executing Script: "+location)
    #    data = self.open_file(location)
    #    self.lex(data)
